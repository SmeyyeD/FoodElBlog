...
function App() {
  ...
  return (
    <>
      <h1 class="text-3xl font-bold text-center mt-2 font-[Gruppo]">FOOD EL BLOG</h1>
      <nav className="flex justify-center gap-[5rem] text-2xl mt-7 font-[Gruppo]">
        <a href="" className='bg-[#e49d22cd] px-6 py-3 rounded-3xl ' >Ana Sayfa</a>
        <a href="" className='bg-[#e49d22cd] px-6 py-3 rounded-3xl' >Aperatifler</a>
        <a href="" className='bg-[#e49d22cd] px-6 py-3 rounded-3xl' >Vegan</a>
        <a href="" className='bg-[#e49d22cd] px-6 py-3 rounded-3xl' >Yemekler</a>
        <a href="" className='bg-[#e49d22cd] px-6 py-3 rounded-3xl' >Tatlılar</a>
        <a href="" className='bg-[#e49d22cd] px-6 py-3 rounded-3xl'>İçecekler</a>
      </nav>
      ...
      <div className='mt-10 px-[50px] flex flex-row-reverse items-center gap-[60px]'>
        ...
        <div className='pb-[50px] '>
          <h1 className='text-3xl font-bold font-[Gruppo]' >Aperatifler</h1>
          <p className='mt-5 text-justify pr-7 font-[Gruppo] text-lg'>
      ...
      <div className='mt-10 px-[50px] flex items-start gap-[50px] pb-10'>
        <img src="images/tatlilar.jpg" alt="" className='h-[350px] rounded-md' />
        <div>
          <h1 className='font-semibold text-3xl font-[Gruppo]'>Tatlılar</h1>
      ...
      <div className='px-[50px] pb-6 mt-5'>
        <h1 className='font-semibold text-2xl font-[Gruppo]'>İletişim</h1>
        <div className='space-y-2 mt-3 font-[Gruppo] text-lg'>
      ...
      <div className='px-[50px] bg-[#edd014] h-26'>
        <h1 className='pt-5 text-2xl text-gray-600 font-[Gruppo]'>Food El Blog</h1>
        <nav className='pt-3 text-lg font-[Gruppo]'>
          <a href="" className=' px-7 rounded-md underline decoration-1' >Ana Sayfa</a>
          <a href="" className=' px-7 rounded-md underline decoration-1' >Aperatifler</a>
          <a href="" className=' px-7 rounded-md underline decoration-1' >Vegan</a>
          <a href="" className=' px-7 rounded-md underline decoration-1' >Yemekler</a>
          <a href="" className=' px-7 rounded-md underline decoration-1' >Tatlılar</a>
          <a href="" className=' px-7 rounded-md underline decoration-1'>İçecekler</a>
        </nav>
        <p className='text-center text-sm text-gray-500 mt-2 pb-1'>@Food El Blog 2022</p>
      </div>
